(function ()
{
    ...
    angular
        ...
        .controller('DecoupagefokontanyController', DecoupagefokontanyController);
    /** @ngInject */
    function DecoupagefokontanyController($mdDialog, $scope, apiFactory, $state,apiUrl)  {
		var vm = this;
		vm.ajout = ajout ;
      ...
      //function cache masque de saisie
        ...
        function test_existance (item,suppression) {          
            if (suppression!=1) {
                vm.allfokontany.forEach(function(reg) {               
					if (reg.id==item.id) {
        ...
        vm.Importer_Region = function() {
			vm.cliquable=0;
			var bla = $.post(apiUrl + "importerdecoupageadministratif/importfichierdecoupageadministratiffokontany",{
