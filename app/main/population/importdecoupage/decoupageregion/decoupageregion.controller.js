(function ()
{
    ...
    angular
        ...
        .controller('DecoupageregionController', DecoupageregionController);
    /** @ngInject */
    function DecoupageregionController($mdDialog, $scope, apiFactory, $state,apiUrl)  {
		var vm = this;
		vm.ajout = ajout ;
		...
		//col table
		vm.region_column = [{titre:"Code"},{titre:"Nom"},{titre:"Chef-Lieu"}];
      ...
      //function cache masque de saisie
        ...
        vm.Importer_Region = function() {
			vm.cliquable=0;
			var bla = $.post(apiUrl + "importerdecoupageadministratif/importfichierdecoupageadministratifregion",{
				...
				// window.location = apiUrlbase+"/exportexcel/envoidedonnees" + "/Reporting envoi de donnees edition du " + data.date + ".xlsx" ;
			});
        };
    }
})();
