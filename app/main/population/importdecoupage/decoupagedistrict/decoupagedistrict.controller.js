    ...
    function DecoupagedistrictController($mdDialog, $scope, apiFactory, $state,apiUrl)  {
      ...
      //function cache masque de saisie
        ...
        function test_existance (item,suppression) {          
            if (suppression!=1) {
                vm.alldistrict.forEach(function(reg) {               
					if (reg.id==item.id) {
        ...
        vm.Importer_Region = function() {
			vm.cliquable=0;
			var bla = $.post(apiUrl + "importerdecoupageadministratif/importfichierdecoupageadministratifdistrict",{
